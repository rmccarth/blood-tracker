...
.. topic:: Technologies List:  

    1) Amazon Web Services (AWS) for Lambda Function (Free Tier)
    2) Amazon Web Services (AWS) for API (Free Tier)
    3) HackTheBox API (Free)
    4) Particle Cloud Web IDE (Free)
    5) Particle Cloud Webhooks (Free)
